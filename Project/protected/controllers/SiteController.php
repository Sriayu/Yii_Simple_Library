...
// create an account model
                ...
                if ($account->save()) {
                    $member = new Member;
                    $account->actionBuildAuthItems($account->id);
...
// display the registration form
    ...
    public function actionBuildAuthItems() {
        try {
            ...
            //$staff_role = $auth->createRole('staff', 'representing a staff');
...
// They can be accessed via: index.php?r=site/page&view=FileName
    ...
    /* public function loadModel($id) {
      ...
      if ($model === null)
      throw new CHttpException(404, 'The requested page does not exist.'); return $model;
      } */
